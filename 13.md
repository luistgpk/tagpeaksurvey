...
<head>
    ...
    <style>
        ...
        /* A cor de fundo da seleção é agora mais suave (sky-100) */
        ...
        /* NÍVEL BAIXO (T-shirt - Azul/Indigo) */
        .product-low-accent { 
        ...
        .product-low-border-selected {
            box-shadow: 0 0 0 3px #a5b4fc !important; /* indigo-300 */
        }
        ...
        .accent-blue-border { border-color: #4f46e5 !important; } /* indigo-600 */


        /* NOVO BOTÃO PRIMÁRIO (INDIGO) */
        .btn-primary {
        ...
        /* NOVO ESTILO: Contêiner de Imagem */
        .product-image-container {
            display: flex;
            justify-content: center;
            align-items: center;
            margin-bottom: 1.5rem;
            height: 150px; /* Altura fixa para evitar deslocamento de layout */
        }
    ...
    <script type="module">
        ...
        const config = {
            ...
            staircase: {
                ...
                // CORREÇÃO: Reduzido de 25 para 8 para garantir que o CT ocorra antes da escada convergir.
        ...
        function renderTraditionalCashbackScreen() {
            // Removido ** e uso de applyBoldAndHighlight
            return `
                <div id="traditional-cashback-screen">
                    <h1 class="text-3xl font-bold text-gray-800 mb-2 text-center text-indigo-600">O que é Cashback?</h1>
                    ...
                    <div class="bg-indigo-50 p-6 rounded-lg border-l-4 border-indigo-400">
                        <p class="text-gray-700 leading-relaxed">
                            O <strong>Cashback tradicional</strong> significa "dinheiro de volta". Quando faz uma compra, uma percentagem do valor gasto é <strong>devolvida</strong> para si.
                            <br><br>
                            Este valor devolvido geralmente fica disponível para <strong>futuras compras</strong> na mesma loja/plataforma ou pode ser <strong>resgatado</strong> para a sua conta bancária após um certo período ou ao atingir um valor mínimo acumulado. 
                            <br><br>
                            A principal característica é que o valor de Cashback é <strong>fixo</strong> e <strong>garantido</strong> no momento da compra, não estando sujeito a quaisquer alterações ou investimentos.
                        </p>
                    </div>
                ...
                <div id="traditional-quiz-screen">
                    ...
                    <div class="space-y-6">
                        <div id="question-group-1" class="p-4 border border-gray-200 rounded-lg">
                            <p class="font-semibold mb-3 text-gray-800">1. Alguma vez já utilizaste <strong>cashback tradicional</strong>?</p>
        ...
        function renderAttentionScreen() {
            // Removido ** e uso de applyBoldAndHighlight, estilo mais suave.
            const content = `
        ...
        function renderExplanationScreen() {
            ...
            const content = `
                <div id="model-explanation-screen">
                    ...
                    <div class="bg-indigo-50 p-6 rounded-lg border-l-4 border-indigo-400">
                        <p class="text-gray-700 leading-relaxed">
                            Este novo modelo de <strong class="text-indigo-700">Cashback</strong> que chega ao mercado propõe que em qualquer compra realizada há a <strong>garantia de Cashback de 0,5%</strong> (do valor da compra).
                            <br><br>
                            Diferentemente do Cashback tradicional, este valor pode <strong>subir e atingir 100%</strong> (o valor total gasto) através de investimentos estratégicos nos mercados financeiros, 
                            <strong>feitos por especialistas com + de 10 anos de experiência em finanças</strong>.
                            <br><br>
                            O investimento ocorre durante <strong>6 meses</strong> e <strong>pode retirar o valor a qualquer momento</strong> que desejar.
                        </p>
                    </div>
                    <p class="text-gray-600 mt-8 mb-8 text-center">Para prosseguir, clique em 'Avançar'.</p>
                    <div class="text-center">
                ...
                <div id="demographics-screen">
                    ...
                    <form id="demographics-form" onsubmit="handleDemographicsSubmit(event)" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-4">
                                <label class="flex items-center space-x-2">
                                    <input type="radio" name="habit" value="Descontos" required class="text-indigo-600 focus:ring-indigo-500">
                                    <span>Descontos (Imediatos/Vales)</span>
                                </label>
                                <label class="flex items-center space-x-2">
                                    <input type="radio" name="habit" value="Cashback normal" class="text-indigo-600 focus:ring-indigo-500">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">8. Qual é o seu rendimento mensal líquido (após impostos)? Por favor, selecione a faixa que melhor representa o seu rendimento médio mensal.</label>
